...
<body class="dark-mode with-custom-css-scrollbars with-custom-webkit-scrollbars">
    ...
    <div class="page-wrapper with-navbar with-sidebar">
        <!-- Modals -->
        <div id="sample-modal-1" class="modal" tabindex="-1" role="dialog">
        ...
        <div id="sample-modal-2" class="modal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-media w-600">
                    <div class="d-flex justify-content-center">
                        <img src="images/item.jpg" alt="item" class="img-fluid">
        ...
        <div id="sample-modal-3" class="modal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-media w-600">
                    <div class="d-flex justify-content-center">
                        <img src="images/item.jpg" alt="item" class="img-fluid">
        ...
        <div class="navbar">
            ...
            <a href="index.html" class="navbar-brand">
                <img src="images/icon.svg" alt="icon" width="30" height="30"> EM6L3M Panel
            </a>
        ...
        <div class="sidebar">
            <div class="sidebar-menu">
                <h6 class="sidebar-title">Option</h6>
                ...
                <h6 class="sidebar-title mt-20">SERVER LIST</h6>
                <div class="sidebar-divider"></div>
                <a href="sms1.html" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                ...
                <a href="sms3.html" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SRV 3
                ...
                <a href="sms10.html" class="sidebar-link sidebar-link-with-icon active">
            ...
            <div class="container-fluid">
                <div class="row row-eq-spacing align-items-center">
                    ...
                    <div class="col-12 col-sm-auto">
                        <h4 class="my-0">
                            <i class="fa-solid fa-pen mr-5"></i> SMS PANEL
                        </h4>
                    </div>
                </div>
